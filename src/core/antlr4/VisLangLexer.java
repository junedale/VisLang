...
public class VisLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"Integer", "Double", "Comment", "Identifier", "Digit", "Whitespace"
		};
	}
	...
	public VisLangLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "VisLang.g4"; }
